        ...
        expect(response).toEqual([
            {
                ...
                request: {
                    ...
                    models: {
                        ...
                        facemesh: {},
                        language: { granularity: "word", identify_speakers: false, sentiment: null, toxicity: null },
                        ner: { identify_speakers: false },
                        prosody: { granularity: "utterance", identify_speakers: false, window: null },
                    },
                    notify: true,
                    registry_files: [],
                    text: [],
