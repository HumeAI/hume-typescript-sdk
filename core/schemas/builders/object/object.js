...
export function object(schemas) {
    ...
    return Object.assign(
        Object.assign(
            Object.assign(Object.assign({}, maybeSkipValidation(baseSchema)), getSchemaUtils(baseSchema)),
            ...
            const baseSchema = {
                ...
                parse: (raw, opts) => {
                    const transformed = schema.parse(
                        raw,
                        Object.assign(Object.assign({}, opts), { unrecognizedObjectKeys: "passthrough" }),
                    );
                    if (!transformed.ok) {
                        return transformed;
                    }
