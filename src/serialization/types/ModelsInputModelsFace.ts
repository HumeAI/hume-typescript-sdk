...
export const ModelsInputModelsFace: core.serialization.ObjectSchema<
    serializers.ModelsInputModelsFace.Raw,
    Hume.ModelsInputModelsFace
...
export declare namespace ModelsInputModelsFace {
    interface Raw {
