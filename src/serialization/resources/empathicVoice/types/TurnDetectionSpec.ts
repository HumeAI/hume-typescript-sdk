...
export const TurnDetectionSpec: core.serialization.ObjectSchema<
    serializers.empathicVoice.TurnDetectionSpec.Raw,
    Hume.empathicVoice.TurnDetectionSpec
...
export declare namespace TurnDetectionSpec {
