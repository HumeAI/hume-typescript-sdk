...
> = core.serialization.object({
  ...
  firstStartTimestamp: core.serialization.property(
    'first_start_timestamp',
    core.serialization.number(),
  ),
  mostRecentStartTimestamp: core.serialization.property(
    'most_recent_start_timestamp',
    core.serialization.number(),
  ),
  numChats: core.serialization.property(
    'num_chats',
    core.serialization.number(),
  ),
  ...
  chatsPage: core.serialization.property(
    'chats_page',
    core.serialization.list(ReturnChat),
  ),
