...
export const SessionSettingsMessage: core.serialization.ObjectSchema<
    serializers.empathicVoice.SessionSettingsMessage.Raw,
...
export declare namespace SessionSettingsMessage {
