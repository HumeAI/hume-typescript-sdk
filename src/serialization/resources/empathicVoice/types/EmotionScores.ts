...
> = core.serialization.object({
  admiration: core.serialization.property(
    'Admiration',
    core.serialization.number(),
  ),
  adoration: core.serialization.property(
    'Adoration',
    core.serialization.number(),
  ),
  aestheticAppreciation: core.serialization.property(
    'Aesthetic Appreciation',
    core.serialization.number(),
  ),
  amusement: core.serialization.property(
    'Amusement',
    core.serialization.number(),
  ),
  ...
  awkwardness: core.serialization.property(
    'Awkwardness',
    core.serialization.number(),
  ),
  boredom: core.serialization.property('Boredom', core.serialization.number()),
  calmness: core.serialization.property(
    'Calmness',
    core.serialization.number(),
  ),
  concentration: core.serialization.property(
    'Concentration',
    core.serialization.number(),
  ),
  confusion: core.serialization.property(
    'Confusion',
    core.serialization.number(),
  ),
  contemplation: core.serialization.property(
    'Contemplation',
    core.serialization.number(),
  ),
  contempt: core.serialization.property(
    'Contempt',
    core.serialization.number(),
  ),
  contentment: core.serialization.property(
    'Contentment',
    core.serialization.number(),
  ),
  ...
  determination: core.serialization.property(
    'Determination',
    core.serialization.number(),
  ),
  disappointment: core.serialization.property(
    'Disappointment',
    core.serialization.number(),
  ),
  disgust: core.serialization.property('Disgust', core.serialization.number()),
  distress: core.serialization.property(
    'Distress',
    core.serialization.number(),
  ),
  ...
  embarrassment: core.serialization.property(
    'Embarrassment',
    core.serialization.number(),
  ),
  empathicPain: core.serialization.property(
    'Empathic Pain',
    core.serialization.number(),
  ),
  entrancement: core.serialization.property(
    'Entrancement',
    core.serialization.number(),
  ),
  envy: core.serialization.property('Envy', core.serialization.number()),
  excitement: core.serialization.property(
    'Excitement',
    core.serialization.number(),
  ),
  ...
  interest: core.serialization.property(
    'Interest',
    core.serialization.number(),
  ),
  ...
  nostalgia: core.serialization.property(
    'Nostalgia',
    core.serialization.number(),
  ),
  ...
  realization: core.serialization.property(
    'Realization',
    core.serialization.number(),
  ),
  ...
  satisfaction: core.serialization.property(
    'Satisfaction',
    core.serialization.number(),
  ),
  shame: core.serialization.property('Shame', core.serialization.number()),
  surpriseNegative: core.serialization.property(
    'Surprise (negative)',
    core.serialization.number(),
  ),
  surprisePositive: core.serialization.property(
    'Surprise (positive)',
    core.serialization.number(),
  ),
  sympathy: core.serialization.property(
    'Sympathy',
    core.serialization.number(),
  ),
  tiredness: core.serialization.property(
    'Tiredness',
    core.serialization.number(),
  ),
