...
export const PostedTurnDetectionSpec: core.serialization.ObjectSchema<
    serializers.empathicVoice.PostedTurnDetectionSpec.Raw,
    Hume.empathicVoice.PostedTurnDetectionSpec
