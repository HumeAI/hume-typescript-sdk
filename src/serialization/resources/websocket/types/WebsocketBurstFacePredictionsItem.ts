...
export const WebsocketBurstFacePredictionsItem: core.serialization.ObjectSchema<
    serializers.WebsocketBurstFacePredictionsItem.Raw,
    Hume.WebsocketBurstFacePredictionsItem
...
export declare namespace WebsocketBurstFacePredictionsItem {
    interface Raw {
        frame?: number | null;
        time?: number | null;
