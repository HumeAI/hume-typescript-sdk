...
export const WebsocketBurstLanguagePredictionsItem: core.serialization.ObjectSchema<
    serializers.WebsocketBurstLanguagePredictionsItem.Raw,
    Hume.WebsocketBurstLanguagePredictionsItem
...
export declare namespace WebsocketBurstLanguagePredictionsItem {
    interface Raw {
        text?: string | null;
