...
import { StreamModelsEndpointPayloadModels } from "./StreamModelsEndpointPayloadModels";
...
> = core.serialization.object({
    ...
    models: StreamModelsEndpointPayloadModels.optional(),
...
export declare namespace StreamModelsEndpointPayload {
    interface Raw {
        data?: string | null;
        models?: StreamModelsEndpointPayloadModels.Raw | null;
