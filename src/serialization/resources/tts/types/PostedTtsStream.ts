...
export const PostedTtsStream: core.serialization.ObjectSchema<
    serializers.tts.PostedTtsStream.Raw,
    Hume.tts.PostedTtsStream
...
export declare namespace PostedTtsStream {
