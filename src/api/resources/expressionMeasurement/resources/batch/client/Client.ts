...
export class Batch {
  ...
  public async listJobs(
    ...
    if (_response.ok) {
      return serializers.expressionMeasurement.batch.listJobs.Response.parseOrThrow(
        _response.body,
        {
  ...
  public async startInferenceJob(
    ...
    const _response = await (this._options.fetcher ?? core.fetcher)({
      ...
      contentType: 'application/json',
      body: serializers.expressionMeasurement.InferenceBaseRequest.jsonOrThrow(
        request,
        {
    ...
    if (_response.ok) {
      return serializers.expressionMeasurement.JobId.parseOrThrow(
        _response.body,
        {
          unrecognizedObjectKeys: 'passthrough',
          allowUnrecognizedUnionMembers: true,
  ...
  public async getJobDetails(
    ...
    if (_response.ok) {
      return serializers.expressionMeasurement.UnionJob.parseOrThrow(
        _response.body,
        {
          unrecognizedObjectKeys: 'passthrough',
          allowUnrecognizedUnionMembers: true,
  ...
  public async getJobPredictions(
    ...
    if (_response.ok) {
      return serializers.expressionMeasurement.batch.getJobPredictions.Response.parseOrThrow(
        _response.body,
        {
          unrecognizedObjectKeys: 'passthrough',
          allowUnrecognizedUnionMembers: true,
