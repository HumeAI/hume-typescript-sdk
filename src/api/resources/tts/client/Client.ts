...
export class Tts {
  ...
  public synthesizeJson(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__synthesizeJson(request, requestOptions),
    );
  }
      ...
      switch (_response.error.statusCode) {
        case 422:
          throw new Hume.tts.UnprocessableEntityError(
            serializers.tts.HttpValidationError.parseOrThrow(
    ...
    switch (_response.error.reason) {
      ...
      case 'timeout':
        throw new errors.HumeTimeoutError(
          'Timeout exceeded when calling POST /v0/tts.',
        );
      case 'unknown':
        throw new errors.HumeError({
  ...
  public synthesizeFile(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__synthesizeFile(request, requestOptions),
    );
  }
  ...
  private async __synthesizeFile(
    ...
    switch (_response.error.reason) {
      ...
      case 'timeout':
        throw new errors.HumeTimeoutError(
          'Timeout exceeded when calling POST /v0/tts/file.',
        );
      case 'unknown':
        throw new errors.HumeError({
          message: _response.error.errorMessage,
  ...
  public synthesizeFileStreaming(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__synthesizeFileStreaming(request, requestOptions),
    );
  }
  ...
  private async __synthesizeFileStreaming(
    ...
    switch (_response.error.reason) {
      ...
      case 'timeout':
        throw new errors.HumeTimeoutError(
          'Timeout exceeded when calling POST /v0/tts/stream/file.',
        );
      case 'unknown':
        throw new errors.HumeError({
          message: _response.error.errorMessage,
  ...
  public synthesizeJsonStreaming(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__synthesizeJsonStreaming(request, requestOptions),
    );
  }
  ...
  private async __synthesizeJsonStreaming(
    ...
    switch (_response.error.reason) {
      ...
      case 'timeout':
        throw new errors.HumeTimeoutError(
          'Timeout exceeded when calling POST /v0/tts/stream/json.',
        );
      case 'unknown':
        throw new errors.HumeError({
          message: _response.error.errorMessage,
  ...
  public convertVoiceFile(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__convertVoiceFile(request, requestOptions),
    );
  }
  ...
  private async __convertVoiceFile(
    ...
    if (request.context != null) {
      _request.append(
        'context',
        (() => {
          const mapped = serializers.tts.PostedContext.jsonOrThrow(
            request.context,
            {
              unrecognizedObjectKeys: 'strip',
              omitUndefined: true,
    ...
    if (request.voice != null) {
      _request.append(
        'voice',
        (() => {
          const mapped = serializers.tts.PostedUtteranceVoice.jsonOrThrow(
            request.voice,
            {
              unrecognizedObjectKeys: 'strip',
              omitUndefined: true,
    ...
    switch (_response.error.reason) {
      ...
      case 'timeout':
        throw new errors.HumeTimeoutError(
          'Timeout exceeded when calling POST /v0/tts/voice_conversion/file.',
        );
      case 'unknown':
        throw new errors.HumeError({
          message: _response.error.errorMessage,
  ...
  public convertVoiceJson(
    ...
    return core.HttpResponsePromise.fromPromise(
      this.__convertVoiceJson(request, requestOptions),
    );
  }
  ...
  private async __convertVoiceJson(
    ...
    switch (_response.error.reason) {
      ...
      case 'timeout':
        throw new errors.HumeTimeoutError(
          'Timeout exceeded when calling POST /v0/tts/voice_conversion/json.',
        );
      case 'unknown':
        throw new errors.HumeError({
          message: _response.error.errorMessage,
