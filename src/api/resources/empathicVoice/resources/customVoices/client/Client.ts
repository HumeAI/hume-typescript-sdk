...
export class CustomVoices {
    ...
    /**
     * @param {Hume.empathicVoice.GetReturnCustomVoicesForUserRequest} request
     ...
     */
    public async getReturnCustomVoicesForUser(
     ...
     *     })
     */
    public async createNewCustomVoice(
     ...
     */
    public async getReturnCustomVoiceByCustomVoiceId(
        id: string,
        requestOptions?: CustomVoices.RequestOptions
    ): Promise<Hume.empathicVoice.ReturnCustomVoice> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
     ...
     *     })
     */
    public async addNewCustomVoiceVersion(
        id: string,
        request: Hume.empathicVoice.PostedCustomVoice,
        requestOptions?: CustomVoices.RequestOptions
    ): Promise<Hume.empathicVoice.ReturnCustomVoice> {
