...
export class Tools {
  ...
  public async createTool(
    ...
    const _response = await (this._options.fetcher ?? core.fetcher)({
      ...
      contentType: 'application/json',
      body: serializers.empathicVoice.PostedUserDefinedTool.jsonOrThrow(
        request,
        {
    ...
    if (_response.ok) {
      return serializers.empathicVoice.tools.createTool.Response.parseOrThrow(
        _response.body,
        {
          unrecognizedObjectKeys: 'passthrough',
          allowUnrecognizedUnionMembers: true,
  ...
  public async createToolVersion(
    ...
    const _response = await (this._options.fetcher ?? core.fetcher)({
      ...
      contentType: 'application/json',
      body: serializers.empathicVoice.PostedUserDefinedToolVersion.jsonOrThrow(
        request,
        {
          unrecognizedObjectKeys: 'strip',
        },
    ...
    if (_response.ok) {
      return serializers.empathicVoice.tools.createToolVersion.Response.parseOrThrow(
        _response.body,
        {
          unrecognizedObjectKeys: 'passthrough',
          allowUnrecognizedUnionMembers: true,
  ...
  public async getToolVersion(
    ...
    if (_response.ok) {
      return serializers.empathicVoice.tools.getToolVersion.Response.parseOrThrow(
        _response.body,
        {
          unrecognizedObjectKeys: 'passthrough',
          allowUnrecognizedUnionMembers: true,
  ...
  public async updateToolDescription(
    ...
    const _response = await (this._options.fetcher ?? core.fetcher)({
      ...
      contentType: 'application/json',
      body: serializers.empathicVoice.PostedUserDefinedToolVersionDescription.jsonOrThrow(
        request,
        {
          unrecognizedObjectKeys: 'strip',
        },
    ...
    if (_response.ok) {
      return serializers.empathicVoice.tools.updateToolDescription.Response.parseOrThrow(
        _response.body,
        {
          unrecognizedObjectKeys: 'passthrough',
          allowUnrecognizedUnionMembers: true,
