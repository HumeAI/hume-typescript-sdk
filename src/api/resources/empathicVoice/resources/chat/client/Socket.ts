...
export class ChatSocket {
  ...
  public sendAudioInput(
    message: Omit<Hume.empathicVoice.AudioInput, 'type'>,
  ): void {
  ...
  public sendSessionSettings(
    message: Omit<Hume.empathicVoice.SessionSettings, 'type'>,
  ): void {
    this.assertSocketIsOpen();
    this.sendJson({
  ...
  public sendAssistantInput(
    message: Omit<Hume.empathicVoice.AssistantInput, 'type'>,
  ): void {
    this.assertSocketIsOpen();
    this.sendJson({
  ...
  public pauseAssistant(
    message: Omit<Hume.empathicVoice.PauseAssistantMessage, 'type'>,
  ): void {
    this.assertSocketIsOpen();
    this.sendJson({
  ...
  public resumeAssistant(
    message: Omit<Hume.empathicVoice.ResumeAssistantMessage, 'type'>,
  ): void {
    this.assertSocketIsOpen();
    this.sendJson({
   ...
   */
  public sendToolResponseMessage(
    message: Omit<Hume.empathicVoice.ToolResponseMessage, 'type'>,
  ): void {
    this.assertSocketIsOpen();
    this.sendJson({
      type: 'tool_response',
   ...
   */
  public sendToolErrorMessage(
    message: Omit<Hume.empathicVoice.ToolErrorMessage, 'type'>,
  ): void {
    this.assertSocketIsOpen();
    this.sendJson({
      type: 'tool_error',
